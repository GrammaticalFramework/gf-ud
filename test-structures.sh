...
gfud cosine-similarity-sort ud/UD_English-EWT/en_ewt-ud-train.conllu out/1-structures-test.conllu -threshold 60 SUBTREETYPE >out/2-structures-test.conllu
